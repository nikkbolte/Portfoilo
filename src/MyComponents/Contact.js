...
const firebaseConfig = {
    ...
    apiKey: "AIzaSyAceIY2VBJT8umTUJ0XkG0MVsiLNZgxSvM",
    authDomain: "nikhilworksheree.firebaseapp.com",
    projectId: "nikhilworksheree",
    storageBucket: "nikhilworksheree.appspot.com",
    messagingSenderId: "1053427328699",
    appId: "1:1053427328699:web:0744e46e712a9f91392b9e",
    measurementId: "G-7KG2R349FD"
...
const Contact = () => {
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      console.error('Error occurred while storing contact form data:', error);
        ...
        <div id="container">
          ...
          <form action="#" method="post" id="contact_form" onSubmit={handleSubmit}>
            ...
            <div className="telephone">
              <label for="name"></label>
              <input type="text" placeholder="Contact No." name="telephone" id="telephone_input" />
            </div>
